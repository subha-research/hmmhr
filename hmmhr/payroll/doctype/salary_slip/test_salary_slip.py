...
from hmmhr.payroll.doctype.payroll_entry.payroll_entry import get_month_details
from hmmhr.payroll.doctype.salary_slip.salary_slip import (
...
from hmmhr.tests.test_utils import get_email_by_subject, get_first_sunday
...
class TestSalarySlip(IntegrationTestCase):
	...
	def test_salary_slip_generation_against_opening_entries_in_ssa(self):
		...
		from hmmhr.payroll.doctype.payroll_period.payroll_period import get_period_factor
		from hmmhr.payroll.doctype.salary_structure.test_salary_structure import make_salary_structure
	...
	def test_tax_payable_with_tax_relief_and_marginal_relief_limits(self):
		from hmmhr.payroll.doctype.salary_structure.test_salary_structure import make_salary_structure
		from hmmhr.regional.india.setup import setup
