...
from hmmhr.payroll.doctype.additional_salary.additional_salary import get_additional_salaries
from hmmhr.payroll.doctype.employee_benefit_application.employee_benefit_application import (
	get_benefit_component_amount,
)
from hmmhr.payroll.doctype.employee_benefit_claim.employee_benefit_claim import (
	get_benefit_claim_amount,
	get_last_payroll_period_benefits,
)
from hmmhr.payroll.doctype.payroll_entry.payroll_entry import get_salary_withholdings, get_start_end_dates
from hmmhr.payroll.doctype.payroll_period.payroll_period import (
	get_payroll_period,
	get_period_factor,
)
from hmmhr.payroll.doctype.salary_slip.salary_slip_loan_utils import (
...
class SalarySlip(TransactionBase):
	...
	def publish_update(self):
		...
		frappe.publish_realtime(
			event="hmmhr:update_salary_slips",
	...
	def pull_sal_struct(self):
		from hmmhr.payroll.doctype.salary_structure.salary_structure import make_salary_slip
	...
	def add_leave_balances(self):
		...
		if frappe.db.get_single_value("Payroll Settings", "show_leave_balances_in_salary_slip"):
			from hmmhr.hr.doctype.leave_application.leave_application import get_leave_details
...
def calculate_tax_by_tax_slab(annual_taxable_earning, tax_slab, eval_globals=None, eval_locals=None):
	from hmmhr.hr.utils import calculate_tax_with_marginal_relief
...
def enqueue_email_salary_slips(names) -> None:
	...
	frappe.enqueue("hmmhr.payroll.doctype.salary_slip.salary_slip.email_salary_slips", names=names)
	frappe.msgprint(
