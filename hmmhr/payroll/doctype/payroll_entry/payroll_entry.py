...
class PayrollEntry(Document):
	...
	def create_overtime_slips(self):
		from hmmhr.hr.doctype.overtime_slip.overtime_slip import (
	...
	def get_overtime_slip_details(self):
		from hmmhr.hr.doctype.overtime_slip.overtime_slip import filter_employees_for_overtime_slip_creation
