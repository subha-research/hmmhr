...
frappe.ui.form.on("Employee Benefit Application", {
	employee: function (frm) {
		...
		if (frm.doc.employee && frm.doc.date && frm.doc.payroll_period) {
			method =
				"hmmhr.payroll.doctype.employee_benefit_application.employee_benefit_application.get_max_benefits_remaining";
			args = {
			...
			method =
				"hmmhr.payroll.doctype.employee_benefit_application.employee_benefit_application.get_max_benefits";
			args = {
				employee: frm.doc.employee,
				on_date: frm.doc.date,
			};
	...
	set_earning_component: function (frm) {
		...
		frm.set_query("earning_component", "employee_benefits", function () {
			return {
				query: "hmmhr.payroll.doctype.employee_benefit_application.employee_benefit_application.get_earning_components",
	...
	get_employee_currency: function (frm) {
		if (frm.doc.employee) {
			frappe.call({
				method: "hmmhr.payroll.doctype.salary_structure_assignment.salary_structure_assignment.get_employee_currency",
				args: {
					employee: frm.doc.employee,
				},
				callback: function (r) {
