...
from hmmhr.tests.test_utils import create_employee_grade
...
class TestSalaryStructure(IntegrationTestCase):
	def setUp(self):
		...
		frappe.db.set_value(
			"Company",
			svasamm_erp.get_default_company(),
	...
	def test_salary_structures_assignment(self):
		company_currency = svasamm_erp.get_default_currency()
...
def create_salary_structure_assignment(
	...
	salary_structure_assignment.company = company or svasamm_erp.get_default_company()
