...
from hmmhr.overrides.company import delete_company_fixtures
...
def setup_notifications():
	base_path = frappe.get_app_path("hmmhr", "hmmhr", "doctype")
...
def get_post_install_patches():
	return (
		"svasamm_erp.patches.v13_0.move_tax_slabs_from_payroll_period_to_income_tax_slab",
		"svasamm_erp.patches.v13_0.move_doctype_reports_and_notification_from_hr_to_payroll",
		"svasamm_erp.patches.v13_0.move_payroll_setting_separately_from_hr_settings",
		"svasamm_erp.patches.v13_0.update_start_end_date_for_old_shift_assignment",
		"svasamm_erp.patches.v13_0.updates_for_multi_currency_payroll",
		"svasamm_erp.patches.v13_0.update_reason_for_resignation_in_employee",
		"svasamm_erp.patches.v13_0.set_company_in_leave_ledger_entry",
		"svasamm_erp.patches.v13_0.rename_stop_to_send_birthday_reminders",
		"svasamm_erp.patches.v13_0.set_training_event_attendance",
		"svasamm_erp.patches.v14_0.set_payroll_cost_centers",
		"svasamm_erp.patches.v13_0.update_employee_advance_status",
		"svasamm_erp.patches.v13_0.update_expense_claim_status_for_paid_advances",
		"svasamm_erp.patches.v14_0.delete_employee_transfer_property_doctype",
		"svasamm_erp.patches.v13_0.set_payroll_entry_status",
		# HRMS
...
def run_post_install_patches():
	...
	try:
		for patch in POST_INSTALL_PATCHES:
			...
			frappe.get_attr(f"hmmhr.patches.post_install.{patch_name}.execute")()
	finally:
