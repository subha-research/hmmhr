...
def get_post_install_patches():
	return (
		"hmmerp.patches.v13_0.move_tax_slabs_from_payroll_period_to_income_tax_slab",
		"hmmerp.patches.v13_0.move_doctype_reports_and_notification_from_hr_to_payroll",
		"hmmerp.patches.v13_0.move_payroll_setting_separately_from_hr_settings",
		"hmmerp.patches.v13_0.update_start_end_date_for_old_shift_assignment",
		"hmmerp.patches.v13_0.updates_for_multi_currency_payroll",
		"hmmerp.patches.v13_0.update_reason_for_resignation_in_employee",
		"hmmerp.patches.v13_0.set_company_in_leave_ledger_entry",
		"hmmerp.patches.v13_0.rename_stop_to_send_birthday_reminders",
		"hmmerp.patches.v13_0.set_training_event_attendance",
		"hmmerp.patches.v14_0.set_payroll_cost_centers",
		"hmmerp.patches.v13_0.update_employee_advance_status",
		"hmmerp.patches.v13_0.update_expense_claim_status_for_paid_advances",
		"hmmerp.patches.v14_0.delete_employee_transfer_property_doctype",
		"hmmerp.patches.v13_0.set_payroll_entry_status",
		# HRMS
