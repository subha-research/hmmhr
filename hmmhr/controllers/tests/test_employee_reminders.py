...
class TestEmployeeReminders(IntegrationTestCase):
	...
	def test_birthday_reminders(self):
		...
		from hmmhr.controllers.employee_reminders import (
	...
	def test_work_anniversary_reminder_not_sent_for_0_years(self):
		...
		from hmmhr.controllers.employee_reminders import get_employees_having_an_event_today
	...
	def test_advance_holiday_reminders_monthly(self):
		from hmmhr.controllers.employee_reminders import send_reminders_in_advance_monthly
	...
	def test_advance_holiday_reminders_weekly(self):
		from hmmhr.controllers.employee_reminders import send_reminders_in_advance_weekly
