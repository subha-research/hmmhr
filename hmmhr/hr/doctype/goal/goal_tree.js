...
frappe.treeview_settings["Goal"] = {
	get_tree_nodes: "hmmhr.hr.doctype.goal.goal.get_children",
	filters: [
		{
			fieldname: "company",
			fieldtype: "Select",
	...
	fields: [
		...
		},
		{
			...
			get_query() {
				return {
					query: "hmmhr.hr.doctype.appraisal.appraisal.get_kras_for_employee",
					filters: {
	...
	get_tree_root: false,
	add_tree_node: "hmmhr.hr.doctype.goal.goal.add_tree_node",
...
function update_progress(node, progress) {
	return frappe
		.call({
			method: "hmmhr.hr.doctype.goal.goal.update_progress",
			args: {
