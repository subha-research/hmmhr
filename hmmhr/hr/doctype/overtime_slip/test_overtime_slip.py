...
from hmmhr.hr.doctype.shift_type.test_shift_type import make_shift_assignment, setup_shift_type
...
class TestOvertimeSlip(IntegrationTestCase):
	...
	def test_overtime_slip_creation_via_payroll_entry(self):
		...
		from hmmhr.payroll.doctype.payroll_entry.test_payroll_entry import get_payroll_entry
