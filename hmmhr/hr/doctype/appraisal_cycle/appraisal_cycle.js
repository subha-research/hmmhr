...
frappe.ui.form.on("Appraisal Cycle", {
		...
		await Promise.all(
			["Employee", "Appraisal Cycle", "Appraisal"].map((doctype) =>
				frappe.model.with_doctype(doctype, () => {
					autocompletions.push(...hmmhr.get_doctype_fields_for_autocompletion(doctype));
				}),
			),
		);
	...
	show_appraisal_summary(frm) {
		...
		frappe
			.call("hmmhr.hr.doctype.appraisal_cycle.appraisal_cycle.get_appraisal_cycle_summary", {
