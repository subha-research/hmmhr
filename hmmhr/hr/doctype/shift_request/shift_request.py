...
import hmmhr
from hmmhr.hr.doctype.shift_assignment.shift_assignment import has_overlapping_timings
from hmmhr.hr.utils import share_doc_with_approver, validate_active_employee
from hmmhr.mixins.pwa_notifications import PWANotificationsMixin
...
class ShiftRequest(Document, PWANotificationsMixin):
	...
	def publish_update(self):
		...
		hmmhr.refetch_resource("hmmhr:my_shift_requests", employee_user)
		hmmhr.refetch_resource("hmmhr:team_shift_requests")
