...
import hmmhr
from hmmhr.hr.utils import validate_active_employee, validate_dates
...
class AttendanceRequest(Document):
	...
	def publish_update(self):
		...
		hmmhr.refetch_resource("hmmhr:my_attendance_requests", employee_user)
		hmmhr.refetch_resource("hmmhr:team_attendance_requests")
