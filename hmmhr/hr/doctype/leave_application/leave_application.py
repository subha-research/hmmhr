...
from hmmhr.hr.doctype.leave_block_list.leave_block_list import get_applicable_block_dates
from hmmhr.hr.doctype.leave_ledger_entry.leave_ledger_entry import create_leave_ledger_entry
from hmmhr.hr.utils import (
...
from hmmhr.utils import get_employee_email
...
class LeaveApplication(Document, PWANotificationsMixin):
	...
	def publish_update(self):
		...
		hmmhr.refetch_resource("hmmhr:my_leaves", employee_user)
		hmmhr.refetch_resource("hmmhr:team_leaves")
